#!/usr/bin/env python3
"""Analyze free flight hover data — Kp/Kd tuning (Kp=[3.0, 3.0, 4.0], Kd=[2.5, 2.5, 3.0])."""

import sqlite3, struct, os
import numpy as np
import matplotlib.pyplot as plt

DB = os.path.join(os.path.dirname(__file__), '2026_04_28_02_Kp_Kd_0.db3')
