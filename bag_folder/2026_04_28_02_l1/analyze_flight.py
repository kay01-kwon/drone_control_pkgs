#!/usr/bin/env python3
"""Analyze flight — L1 adaptive control."""

import sqlite3, struct, os
import numpy as np
import matplotlib.pyplot as plt

DB = os.path.join(os.path.dirname(__file__), '2026_04_28_02_l1_0.db3')
...
dob_ts, dob_raw = load_topic(db, '/l1_adaptive/wrench', parse_wrench); dob = np.array(dob_raw)
