#!/usr/bin/env python3
"""Analyze flight — eps_f=0.15 (Option A+C: Kp_z=5, Kd_z=3.5, eps_f=0.15)."""

import sqlite3, struct, os
import numpy as np
import matplotlib.pyplot as plt

DB = os.path.join(os.path.dirname(__file__), '2026_04_28_02_eps_f_015_0.db3')
...
TITLE = 'Kp=[2,2,5], Kd=[2,2,3.5], eps_f=0.15'
